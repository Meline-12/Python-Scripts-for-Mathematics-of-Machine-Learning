...
% opt = detectImportOptions('alpha_S.csv');
% opt_2 = detectImportOptions('isSV.csv');
% opt_2 = setvartype(opt_2,{'Var1'},'double');
% alpha_S = readtable('alpha_S.csv', opt);
% isSV = readtable("isSV.csv", opt_2);
% isSV = table2array(isSV);

% alpha_S = readtable('alpha_S.csv');
% alpha_S = table2array(alpha_S);
% isSV = readtable("isSV.csv");
% isSV = table2array(isSV);
% isSV = logical(isSV);
% 
% 
